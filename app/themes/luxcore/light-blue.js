...
export default {
  ...
  '--theme-nav-sideitem-background-color-hover': '#ebeff2',
  '--theme-nav-sideitem-background-color-active': '#4cc6de',
  '--theme-nav-sideitem-text-color': '#1e304a',
  ...
  '--theme-sidebar-background-color': '#f8f9fa',
  '--theme-sidebar-category-background-color-hover': '#d8dce2',
  '--theme-sidebar-category-background-color-active': '#d8dce2',
  ...
  '--theme-sidebar-menu-logo-text-color': '#1e304a',
  ...
  '--theme-luxgate-primary-background-color-hover': '#f8f9fa',
  '--theme-luxgate-assist-background-color': '#f8f9fa',
